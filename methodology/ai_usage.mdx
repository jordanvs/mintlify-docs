...
<AccordionGroup>
  <Accordion title="Machine Learning for Predictive Intelligence">
    ...
    - Commonly used in our analytics pipelines are algorithms and libraries including: Pearson Correlation/R^2, Logistic Regression, Random Forest, XGBoost, K-Means, SMOTE, Optimal Binning, and more.
  </Accordion>
...
Visit our [Trust and Compliance](https://trust.apexscore.ai) portal to learn more about how we ensure the highest standards of data security and privacy.