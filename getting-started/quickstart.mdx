...
We [field, purchase, synthesize, or otherwise collect](/motivations/measurement) data from a short motivational survey to a defined audience segment (minimum 400 responses). We use your existing data investments as inputs. We'll guide you in gathering what's helpful:
...
<Frame>
    <img src="/images/product-flow.png" alt="Product Flow" />
</Frame>
...
Apex will generate custom [**MotiveModels**](/product/motivemodel) which are behavioral-science-backed representations of what motivates your key customer segments to advocate and be loyal. 
</ParamField>
...
[**MotiveModels**](/product/motivemodel), while useful on their own for Marketers, Product Leaders, and Strategy Builders, can be focused to inform a specific business goal (such as reducing churn, improving upsell, winning a daypart or activating new customers for example) through [**MotivePath**](/product/motivepath). **MotivePath** combines holistic motivational, behavioral, transactional, and demographic data to simulate and prescribe the most effective actions for your specific goals. 
</ParamField>
...
[**MotiveLoop**](product/motiveloop) is an always-on intelligence layer that delivers recurring [**MotiveModels**](/product/motivemodel) across your key customer segments and can generate [**MotivePaths**](/product/motivepath) quickly and effectively without the need for a full data refresh.
</ParamField>
...
To provide an idea of the time commitment required from your organization/team, we've outlined a "cold-start", basic engagement plan below that would focus on building one or more [**MotiveModels**](/product/motivemodel), analyzing them, and reporting on the results as a one-time project.
...
- ❌ We only **optionally** use data you already have
