...
We offer transparency on [how these motivators were developed](/motivations/statistical_validation).
...
The result is strategy that is informed by "**humanized data**".
