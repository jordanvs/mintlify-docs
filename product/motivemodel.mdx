...
2. **Design the survey**  
   Collaborate with Apex to deploy a short instrument built around our 16 motivational drivers, customized to your category or customer journey. Learn about our [measurement techniques](/motivations/measurement).

3. **Collect motivational data**  
   Run the survey with your audience to uncover which motivators matter most for key outcomes like loyalty, purchase, or advocacy.

4. **(Optional) Integrate your other data**  
...
5. **Model and analyze**  
    ...
    Receive your results via platform access ([**MotiveLoop**](/product/motiveloop) only), expert report, or executive presentation, ready to apply across marketing, product, CX, and operations.
